...
\documentclass[letterpaper,12pt]{report}
  ...
  % see https://tex.stackexchange.com/questions/29973/more-than-one-optional-argument-for-newcommand
    ...
    \NewDocumentCommand{\innerprod}{O{\cdot} O{\cdot}}{\ensuremath{\left<#1,#2\right>}}
...
with a nice helping of complex analysis.
I hope to get the chance to learn them properly myself.
...
\paragraph{Unitary operators over Hilbert spaces.}
